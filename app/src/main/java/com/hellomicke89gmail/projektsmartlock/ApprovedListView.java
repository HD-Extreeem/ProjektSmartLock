...
public class ApprovedListView extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
    ...
    private class MyBroadCastReciever extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getAction().equals("Change to card id data on server")){
    ...
    public void showInputDialog(final String key) {
        ...
        LayoutInflater inflater=LayoutInflater.from(ApprovedListView.this);
        View promptView=inflater.inflate(R.layout.input_dialog, null);
        AlertDialog.Builder alertDialogBuilder= new AlertDialog.Builder(ApprovedListView.this);
    ...
    public void showInputSearchDialog() {
        ...
        alertDialogBuilder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                new AsyncTaskLogGET( ApprovedListView.this,authString,logType).execute();
            }
    ...
    public void showPopUp(View v, String key) {
        ...
        popupMenu.setOnMenuItemClickListener(ApprovedListView.this);
